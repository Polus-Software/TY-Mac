...
class CourseController extends Controller
{
    public function index() {
        ...
        foreach ($courses as $course) {
            ...
            $courseCategoryname = DB::table('course_category')->
                join('courses', 'course_category.id', '=', 'courses.category')->
                select('course_category.category_name')->
                where('course_category.id', $course->category)->value('course_category.category_name');
    ...
    public function saveCourse(Request $request) {
        ...
        if($user->role_id == $userType){
            foreach($admins as $admin) {
                ...
                Mail::to('infosmtp')->to($admin->email)->send(new mailAfterCourseCreation($data));
        ...
        $datas = [
         ...
         Mail::to('infosmtp')->to($instructorEmail)->send(new InstructorMailAfterassigningCourse($datas));
