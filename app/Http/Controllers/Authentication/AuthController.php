...
class AuthController extends Controller
{
    ...
    public function signupProcess(Request $request) {
        try{
            ...
            Mail::to('infosmtp')->to($email)->send(new SignupMail($details));
    ...
    public function loginProcess(Request $request)
    {
        ...
        if (Auth::attempt($credentials)) {
            ...
            if($request->redirect == 'session') {
               ...
               // $redirectTo = url('/') . '/register-course?id='; 
            }  
    ...
    public function contactUs(Request $request) {
        try {
            ...
            foreach($admins as $admin) {
                ...
                Mail::to('smtp')->to($admin->email)->send(new MailAfterContactUsSubmission($details));
                $notification = new Notification; 
                $notification->user = $admin->id;
