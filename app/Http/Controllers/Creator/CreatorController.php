            ...
            if ($creator) {
                ...
                if(count($creators)) {
                    foreach($creators as $creator) {
                        ...
                        $html = $html . '<td class="align-middle"><img src="/storage/images/'. $creator->image .'" class="rounded-circle" alt="" style="width:40px; height:40px;"></td>';
                        ...
                        $html = $html . '<td class="align-middle">' . Carbon::createFromFormat("Y-m-d H:i:s", $creator->created_at)->format("m/d/Y") . '</td>';
