...
class InstructorController extends Controller
{
    ...
    public function saveInstructor(Request $request) {
        ...
        $validatedData = $request->validate([
            ...
            'twitter_social' => 'nullable|active_url',
            'linkedin_social' => 'nullable|active_url',
            'youtube_social' => 'nullable|active_url',
        ...
        try {
            ...
            $validatedData = $request->validate([
               ...
               'email' => ['required', Rule::unique('users')->ignore($instructor_id)],
                'description' => 'required',
                'twitter_social' => 'url|nullable',
                'linkedin_social' => 'url|nullable',
                'youtube_social' => 'url|nullable',
                //'signature' => 'required',
            ...
            if ($instructor) {
                ...
                if(count($instructors)) {
                    foreach($instructors as $instructor) {
                        ...
                        $html = $html . '<td class="align-middle"><img src="/storage/images/'. $instructor->image .'" class="rounded-circle" alt="" style="width:40px; height:40px;"></td>';
