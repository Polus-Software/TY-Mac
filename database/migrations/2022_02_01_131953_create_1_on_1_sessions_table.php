...
class Create1On1SessionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('1_on_1_sessions', function (Blueprint $table) {
            $table->id();
            ...
            $table->boolean('is_screen_shared');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('1_on_1_sessions');
    }
}
