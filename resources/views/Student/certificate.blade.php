        ...
        <div class="col-lg-12 d-flex justify-content-center">
            <div class="card text-center" style="margin: auto; width: 100%; border: 1px solid grey; margin-bottom:30px;">
                <div class="card-body">
                    ...
                    <small style="position: absolute; right: 15px; top:40px;">{{$courseDetail['date_of_issue']}}</small>
                  ...
                  <div class="row">
                      <div class="col-lg-12">
                       <img src="{{ asset('/storage/signatures/'. $courseDetail['instructor_signature']) }}" alt=""> 
                    </div>
                      <div class="col-lg-12">
