...
@section('content')
    <style>
        ...
        .instructor-assignment-table tr,
        .instructor-assignment-table td {
    ...
    <div class="modal fade" id="instructAssignModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content" style="width: 35rem;">
                ...
                <div class="modal-body" style="padding: 0 3rem 0rem 3rem;">
                    ...
                    <table class="mt-3 w-100">
                        <tr>
                            ...
                            <td colspan="1" style="font-size: 14px;font-weight: 600;"><span
                                    id="modal_student_name"></span><br>
                                <small class="text-truncate">Batch: <span id="modal_batch_name"
                                        style="color:#6a6a6a;font-weight:500;"></span></small>
                            </td>
                            <td style="text-align:right;vertical-align:bottom;"><small
                                    style="font-size: 12px;color:#6a6a6a;font-weight:500;">1 Document Attached</small></td>
                        </tr>
                        <tr>
                            <td colspan="3">
                                <div class="assignment_list_div">
                                    <span id="assignment_title">Assignment Title</span>
                                    <a id="modal_file_download" href="" class="btn btn-secondary" target="_blank"
                                        style="float: right;"><i class="fa fa-download"></i> Download File</a>
                                </div>
                            </td>

                        </tr>
                    </table>
                    <div id="modal_comment_div" class="llpcard-inner bg-light mt-3 mb-3"
                        style="padding: 1rem 1rem 3rem 1rem;display:none;">
                        ...
                        <textarea style="font-size: 13px;font-weight:500;" style="height: 110px;" class="form-control" type="text"
                            name="assignment_comment" placeholder="Type your comment here.."></textarea>
                    </div>
                </div>
                ...
                <div class="modal-footer" style="border-top:none;">
                    ...
                    <button id="assign_completed" type="button" class="btn btn-secondary"
                        data-assignment="">Completed</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body session-modal-body">
                    <p class="session-text">
                        This is to confirm that both the parties (Instructor and student) have agreed upon the time of
                        joining this session on proper notice. Please click on "Continue" if you wish to proceed to the
                        session.
                        Only clicking the continue button, an email will be sent to the respective student with the link for
                        joining this session. All the best!
                    </p>
                </div>
                <div class="modal-footer session-modal-footer">
                    <button style="color: #5c636a;background-color: #fff;font-size: 13px;" type="button"
                        class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button id="1_on_1_session_start" style="font-size: 13px;" type="button" class="btn btn-secondary"
                        data-student-id="" data-topic-id="">Continue</button>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="row g-0">
                            <div class="col-lg-4 col-md-12 col-sm-12 col-12 think-img-thumb-container">
                                @foreach ($singleCourseDetails as $course)
                                    <img src="{{ asset('/storage/courseThumbnailImages/' . $course['course_thumbnail_image']) }}"
                                        class="img-fluid col-md-12 col-sm-12 col-12 h-100 course-image" alt="coursepicture">
                                @endforeach
                            </div>
                                ...
                                <div class="card-body think-align-middle">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-12">
                                            <p class="para-1 text-truncate"><img class="me-1"
                                                    src="/storage/icons/category__icon.svg" alt="error">
                                                @foreach ($singleCourseDetails as $course)
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-12">
                                            <p class="para-1 text-truncate think-text-color-grey fw-bold"><i
                                                    class="far fa-user pe-1"></i>
                                                @foreach ($singleCourseDetails as $course)
                                        ...
                                        <div class="col-lg col-md-3 col-sm-3 col-12 d-flex justify-content-end">
                                            <p class="para-2 think-text-color-grey fw-bold">
                                                <img class="me-1" src="/storage/icons/level__icon.svg"
                                        ...
                                        @if ($userType == 'instructor')
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-12 text-end">
                                                <a href="/choose-cohort?id={{ $course['id'] }}"
                                                    id="batch-selection">Back</a>
                                            </div>
                                        @endif
                                        @if ($userType == 'instructor')
            ...
            <div class="row mb-5">
                <div class="col-lg-3 col-md-4 col-sm-12 col-12 vertcalNav mb-3">
                    <div class="row sidebar pt-4">
                        ...
                        <div class="nav flex-column nav-pills d-flex align-items-start pe-0 pt-4 pb-4" id="v-pills-tab"
                            role="tablist" aria-orientation="vertical">
                            @if ($userType == 'instructor')
                                <button class="nav-link align-items-center mb-2 ps-4 pe-4 d-flex text-start active"
                                    id="v-pills-cohortOverview-tab" data-bs-toggle="pill" data-bs-target="#cohort-overview"
                                    type="button" role="tab" aria-controls="v-pills-cohortSchedule" aria-selected="true">
                                    <i class="fas fa-chart-bar pe-3"></i><span>Cohort Overview</span>
                                </button>
                            @endif
                            <button
                                class="nav-link align-items-center {{ $userType == 'student' ? 'active' : '' }} mb-2 ps-4 pe-4 d-flex text-start"
                                id="v-pills-cohortSchedule-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-cohortSchedule" type="button" role="tab"
                                aria-controls="v-pills-cohortSchedule" aria-selected="true">
                                <img src="/storage/icons/_cohort_schedule.svg" alt="error"
                                    class="pe-3"><span>Cohort Schedule</span>
                            </button>
                            <button class="nav-link align-items-center mb-2 ps-4 pe-4 d-flex text-start"
                                id="v-pills-personalizedRecommondations-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-personalizedRecommendations" type="button" role="tab"
                                aria-controls="v-pills-CohortQuestions" aria-selected="false">
                                <img src="/storage/icons/_personalized_recommendations.svg" alt="error"
                                    class="pe-3"><span>Personalized Recommendations</span>
                            </button>
                            <button class="nav-link align-items-center mb-2 ps-4 pe-4 d-flex text-start"
                                id="v-pills-CohortQuestions-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-CohortQuestions" type="button" role="tab"
                                aria-controls="v-pills-CohortQuestions" aria-selected="false">
                                <img src="/storage/icons/_cohort_Q&A.svg" alt="error" class="pe-3"><span>Cohort
                                    Q&A</span>
                            </button>
                            <button class="nav-link align-items-center mb-2 ps-4 pe-4 d-flex text-start"
                                id="v-pills-cohortInfo-tab" data-bs-toggle="pill" data-bs-target="#v-pills-cohortInfo"
                                type="button" role="tab" aria-controls="v-pills-cohortInfo" aria-selected="false">
                                <img src="/storage/icons/_cohort_info.svg" alt="error" class="pe-3"><span>Cohort
                                    Info</span>
                            </button>
                            <button class="nav-link align-items-center mb-2 ps-4 pe-4 d-flex text-start"
                                id="v-pills-personalizedActivity-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-personalizedActivity" type="button" role="tab"
                                aria-controls="v-pills-personalizedActivity" aria-selected="false">
                                <img src="/storage/icons/_assignments.svg" alt="error"
                                    class="pe-3"><span>Personalized Activity</span>
                            </button>
                            @if ($userType == 'student')
                                <button class="nav-link align-items-center mb-2 ps-4 pe-4 d-flex text-start"
                                    id="v-pills-certificate-tab" data-bs-toggle="pill" data-bs-target="#v-pills-certificate"
                                    type="button" role="tab" aria-controls="v-pills-certificate" aria-selected="false">
                                    <img src="/storage/icons/_completion _certificate.svg" alt="error"
                                        class="pe-3"><span>Completion Certificate</span>
                                </button>
                                ...
                                <button class="nav-link bg-transparent p-0" id="v-pills-achievements-tab"
                                            data-bs-toggle="pill" data-bs-target="#v-pills-achievements" type="button"
                                            role="tab" aria-controls="v-pills-achievements" aria-selected="false">
                                            <img src="/Badges/More.svg" alt="" style="position: relative;top: -100%;left: 268.8%;">
                                </button>
                                <div class="border-top col-12 mt-4 py-4 text-center px-4">
                                    <a class="btn think-btn-transparent w-100" id="reviewButton" data-bs-toggle="modal"
                                        data-bs-target="#reviewModal">Add Course Review</a>
                                </div>
                            @endif
                        </div>
                ...
                <div class="col-lg-9 col-md-8 col-sm-12 col-12 gx-5 pe-3">
                    <div class="tab-content" id="v-pills-tabContent">
                        <!-- overview tab -->
                        @if ($userType == 'instructor')
                            <div class="tab-pane fade show {{ $userType == 'instructor' ? 'active' : '' }}"
                                id="cohort-overview" role="tabpanel" aria-labelledby="cohort-overview">
                        ...
                        <!-- overview tab -->
                        <!-- schedule tab -->
                        <div class="tab-pane fade show {{ $userType == 'student' ? 'active' : '' }}"
                            id="v-pills-cohortSchedule" role="tabpanel" aria-labelledby="v-pills-cohortSchedule">
                            <div class="card card-2 mb-3">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-12">
                                            @if ($userType == 'student')
                                                <a class="btn btn-secondary think-btn-secondary"
                                                    href="{{ route('study.materials') }}?course={{ $course['id'] }}"
                                                    style="white-space:nowrap;">Go to course materials</a>
                                            @elseif($userType == 'instructor')
                                                <a class="btn btn-secondary think-btn-secondary"
                                                    href="{{ route('study.materials') }}?course={{ $course['id'] }}&batchId={{ $selectedBatch }}"
                                                    style="white-space:nowrap;">Go to course materials</a>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    @foreach ($topicDetails as $topicDetail)
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                                <h6 class="card-title pt-2" data-id="{{ $topicDetail['topic_id'] }}">
                                                    Session {{ $sl_no }} - {{ $topicDetail['topic_title'] }}</h6>
                                            </div>
                                            <div
                                                class="col-lg-6 col-md-6 col-sm-6 col-12 d-flex justify-content-lg-end justify-content-md-end mt-2">
                                                @if ($topicDetail['liveId'] == null)
                                                    @if ($topicDetail['scheduled'] == true)
                                                        <span class="duration" style="font-size:14px;"><i class="far fa-clock pe-1"></i> Next Live
                                                            Class: <small>{{ $topicDetail['nextCohort'] }}</small></span>
                                                    @else
                                                        <span class="text-muted" style="font-size:14px;">No sessions
                                                            scheduled</span>
                                                    @endif
                                                @elseif($topicDetail['liveId'] == 'Over')
                                                    <a style="color: #6E7687;background-color: #F8F7FC;" type="button"
                                                        class="btn"
                                                        href="/view-again/{{ $topicDetail['overId'] }}"><i
                                                            class="fas fa-undo pe-2"></i>View again</a>
                                                @elseif($topicDetail['liveId'] == 'Wait')
                                                    <span class="text-muted"
                                                        style="font-size:14px;text-decoration:underline;">Instructor yet to
                                                        join, please be patient.</span>
                                                @else
                                        ...
                                        @foreach ($topicDetail['topic_content'] as $content)
                                            <li class="ms-3 border-0 pb-2" style="list-style:circle;">
                                                {{ $content->topic_title }}</li>
                                        @endforeach
                                        </ul>
                                    @endforeach
                                </div>
                                    ...
                                    @forelse($recommendations as $recommendation)
                                        <div class="col-lg-6 mb-3">
                                            <div class="card card-3">
                                                <img src="/courselist/Illustration/Mask Group 2.jpg" class="card-img-top"
                                                    alt="...">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <a href="/view-again/{{ $recommendation['sessionId'] }}?recommendation=true&content={{ $recommendation['content_id'] }}"
                                                                class="btn btn-primary w-100">View again</a>
                                                        </div>
                                                    </div>
                                                    <div class="row mt-3">
                                                        <div class="col-lg-12">
                                                            <div class="card card-4">
                                                                <div class="card-body text-center fw-bold">
                                                                    You have understood
                                                                    {{ $recommendation['understoodPercent'] }}% of the
                                                                    topic. We recommend that you view these topics again.
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row mt-3">
                                                        <div class="col-lg-12">
                                                            <h6 class="card-title">
                                                                {{ $recommendation['topic_title'] }}</h6>
                                                            <ul class="list-group list-group-flush border-bottom pb-3">
                                                                <li class="ms-3 border-0 pb-2">
                                                                    {{ $recommendation['content_title'] }}</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <!-- schedule tab -->
                        <!-- Recommendations tab -->
                        <div class="tab-pane fade" id="v-pills-personalizedRecommendations" role="tabpanel"
                            aria-labelledby="v-pills-personalizedRecommendations-tab">
                            <div class="card card-2">
                                <div class="card-body">
                                    <div class="row border-bottom">
                                        ...
                                        @endif
                                        <h5 class="heading-1">
                                            {{ $userType == 'student' ? 'Recommended Topics to Review' : 'Personalized Recommendations' }}
                                        </h5>
                                        </div>

                                    @if ($userType == 'student')
                                        <div class="col-lg-2">
                                            <button data-course="{{ $course['id'] }}" data-student="{{ $studentId }}"
                                                data-instructor={{ $instructorId }} id="contact-instructor"
                                    ...
                                    @if ($userType == 'instructor')
                                        <div
                                            class="col-lg-6 col-md-6 col-sm-6 col-12 d-flex justify-content-lg-end justify-content-md-end mb-2">
                                            <div id="name-search-form"
                                                class="mb-2 mb-lg-0 mt-lg-0 d-flex mt-3 col-md-9 col-sm-9 col-6">
                                                @csrf
                                                <input class="form-control me-2" type="search" placeholder="Search a name"
                                                    aria-label="Search" id="name-search-box">
                                                <button class="btn btn-outline-dark" type="button"
                                                    id="name-search-btn">Search</button>
                                            </div>
                                        </div>
                                    @endif
                                </div>
                                                            ...
                                                            <div class="row mt-3">
                                                                <div class="col-lg-12">
                                                                    <div class="card card-4">
                                                                        <div class="card-body text-center fw-bold">
                                                                            You have understood
                                                                            {{ $recommendation['understoodPercent'] }}%
                                                                            of
                                                                            the topic. We recommend that you view these
                                                                            topics again.
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row mt-3">
                                                                <div class="col-lg-12">
                                                                    <h6 class="card-title">
                                                                        {{ $recommendation['topic_title'] }}</h6>
                                                                    <ul
                                                                        class="list-group list-group-flush border-bottom pb-3">
                                                                        <li class="ms-3 border-0 pb-2">
                                                                            {{ $recommendation['content_title'] }}</li>
                                                                    </ul>
                                                                </div>
                                                ...
                                                @foreach ($studentsEnrolled as $student)
                                                    <div class="accordion-item border-0 bg-light">
                                                        <h2 class="accordion-header" id="headingOne">
                                                            <button
                                                                class="accordion-button shadow-none text-capitalize mb-2p-2"
                                                                type="button" data-bs-toggle="collapse"
                                                                data-bs-target="#collapseOne_{{ $student->id }}"
                                                                aria-expanded="true"
                                                                aria-controls="collapseOne_{{ $student->id }}">
                                                                <img src="/storage/images/{{ $student->image }}"
                                                                    class="rounded-circle me-3" alt=""
                                                                    style="width:40px; height:40px;object-fit: cover;">
                                                                <p class="pt-3 card-title-4">
                                                                    {{ $student->firstname . ' ' . $student->lastname }}
                                                                </p>
                                                                <a data-student="{{ $student->id }}"
                                                                    data-instructor={{ $instructorId }}
                                                                    data-course="{{ $courseId }}" href="#"
                                                                    class="btn btn-outline-secondary ms-auto messageStudent"><i
                                                                        class="fas fa-comments pe-2"></i>Message
                                                        ...
                                                        <div id="collapseOne_{{ $student->id }}"
                                                            ...
                                                            <div class="accordion-body bg-white ps-5 pe-5">
                                                                <div class="row mt-3 mb-3">
                                                                    @if (!empty($recommendations))
                                                                                            ...
                                                                                            <div class="row">
                                                                                                <div
                                                                                                    ...
                                                                                                    <button
                                                                                                        ...
                                                                                                        data-bs-student-id="{{ $recommendation['student_id'] }}"
                                                                                                        data-bs-topic-id="{{ $recommendation['content_id'] }}">1-on-1
                                                                                                        Session</button>
                                                                                                </div>
                                                                                                <div
                                                                                                    class="col-lg-6">
                                                                                                    <button type="button"
                                                                                                        ...
                                                                                                        data-bs-student-id="{{ $recommendation['student_id'] }}"
                                                                                                        data-bs-topic-id="{{ $recommendation['topic_id'] }}">Chart</button>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="row mt-3">
                                                                                                <div
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <ul
                                                                                                                class="list-group list-group-flush pb-3 mt-3">
                                                                                                                <li
                                                                                                                    class="ms-3 border-0 pb-2">
                                                                        ...
                                                                        @endforeach
                                                                    @else
                                                                        <x-nodatafound message="No recommendations yet!"
                                                                            notype="" />
                                                                    @endif
                                                                </div>
                                                            </div>
                    ...
                    <div class="tab-pane fade" id="v-pills-CohortQuestions" role="tabpanel"
                        aria-labelledby="v-pills-CohortQuestions-tab">
                        <div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <div class="card-body">
                                        <div class="row border-bottom">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-end mb-3">
                                                @if ($userType == 'student')
                                                    <button id="ask_a_question" type="button" class="btn"
                                                        data-bs-toggle="modal" data-bs-target="#questionModal">Ask a
                                                        question</button>
                                                @endif
                                            </div>
                                            ...
                                            @if (!empty($qas))
                                                @foreach ($qas as $qa)
                                                    <div
                                                        ...
                                                        @foreach ($singleCourseDetails as $course)
                                                            <img src="{{ asset('/storage/images/' . $qa['student_profile_photo']) }}"
                                                                class="img-fluid rounded-circle mt-3" alt="..."
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            @if ($userType == 'instructor' && !$qa['hasReplied'])
                                                                <div class="row"
                                                                    id="replyTextArea_{{ $qa['id'] }}">
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                                        @csrf
                                                                        <textarea id="reply_{{ $qa['id'] }}" class="form-control autosize" placeholder="Type your reply.."
                                                                            maxlength="2000"></textarea>
                                                                        <button data-id="{{ $qa['id'] }}"
                                                                            style="float:right;"
                                                                            class="btn btn-dark replyBtn mt-2">Reply</button>
                                                                    </div>
                                                                </div>
                                                            @endif
                                                        </div>
                                                    ...
                                                    @if ($qa['hasReplied'])
                                                        <div class="row ps-5">
                                                        @else
                                                            <div class="row ps-5" id="replyDiv_{{ $qa['id'] }}"
                                                                style="display:none">
                                                    @endif
                                                    <div
                                                        class="col-lg-12 col-md-12 col-sm-12 col-12 d-flex justify-content-center ps-5 pe-0">
                                                        @foreach ($singleCourseDetails as $course)
                                                            <img src="{{ asset('/storage/images/' . $course['profile_photo']) }}"
                                                                class="img-fluid rounded-circle mt-3" alt="..."
                                                                style="width:40px; height:40px;">
                                                        @endforeach
                                                        <div class="card-body">
                                                                ...
                                                                <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                                                                    <p class="card-title text-left">
                                                                        @foreach ($singleCourseDetails as $course)
                                                                            ...
                                                                            {{ $course['instructor_lastname'] }}
                                                                            &nbsp;<span
                                                                                class="d-block fs-14 fst-italic fw-normal text-muted text-truncate">{{ $course['designation'] }}
                                                                                at {{ $course['institute'] }}</span>
                                                                        @endforeach
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                                    <p class="para-1 text-break"
                                                                        id="replyContent_{{ $qa['id'] }}">
                                                                        {{ $qa['reply'] }}
                                                                    </p>
                                                                </div>
                                                            </div>
...
<!-- Cohort info starts -->
                <div class="tab-pane fade" id="v-pills-cohortInfo" role="tabpanel"
                    aria-labelledby="v-pills-cohortInfo-tab">
                                ...
                                <div class="card card-8 mb-5">
                                    <div class="row g-0 border-bottom think-bg think-br">
                                        <div class="col-lg-2 col-sm-4 col-4">
                                            @foreach ($singleCourseDetails as $course)
                                                <img src="{{ asset('/storage/images/' . $course['profile_photo']) }}"
                                                    class="img-fluid rounded-circle m-2 p-2 d-flex align-items-center"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <p><a style="color:black;"
                                                    href="@foreach ($singleCourseDetails as $singleCourseDetail) {{ $singleCourseDetail['instructorTwitter'] }} @endforeach"
                                                    target="_blank"><i class="fab fa-twitter pe-2"></i></a>
                                                <a style="color:black;"
                                                    href="@foreach ($singleCourseDetails as $singleCourseDetail) {{ $singleCourseDetail['instructorLinkedin'] }} @endforeach"
                                                    target="_blank"><i class="fab fa-linkedin-in pe-2"></i></a>
                                                <a style="color:black;"
                                                    href="@foreach ($singleCourseDetails as $singleCourseDetail) {{ $singleCourseDetail['instructorYoutube'] }} @endforeach"
                ...
                @if ($userType == 'instructor')
                    <div class="tab-pane fade" id="v-pills-personalizedActivity" role="tabpanel"
                        aria-labelledby="v-pills-personalizedActivity-tab">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card card-2">
                                    <div class="card-body p-4">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    @foreach ($assignments as $assignment)
                                                        @php($aSlNo = $aSlNo + 1)
                                                        <th scope="col"><small style="color:#7e8c9a;">Assignment
                                                                {{ $aSlNo }}</small><br>{{ $assignment->assignment_title }}
                                                        </th>
                                                    @endforeach
                                                </tr>
                                            </thead>
                                                ...
                                                @if (count($assignmentArr) != 0)
                                                    @foreach ($assignmentArr as $assignment)
                                                        <tr>
                                                            ...
                                                            <td colspan="3" style="font-size: 14px;font-weight: 600;"><img
                                                                    src="/storage/images/{{ $assignment['studentImg'] }}"
                                                                    id="modal_student_img" /><span
                                                                    id="assignment_table_student">{{ $assignment['student_name'] }}</span><br>
                                                                <small id="assignment_table_batch"
                                                                    class="text-truncate">Batch: <span
                                                                        style="color:#6a6a6a;font-weight:500;">{{ $assignment['batch_name'] }}</span></small>
                                                            </td>

                                                            @foreach ($assignment['assignment_data'] as $data)
                                                                @if ($data['status'] == 'Submitted')
                                                                    <td style="vertical-align: middle;font-size: 13px;color:#74648C !important;"
                                                                        id="{{ $data['assignment_id'] }}"><i
                                                                            class="fas fa-file"></i> <a
                                                                            style="color:#74648C !important;" href="#"
                                                                            data-bs-toggle="modal"
                                                                            data-bs-target="#instructAssignModal"
                                                                            bs-data-assignment="{{ $data['stuAssignment'] }}">
                                                                            {{ $data['status'] }}</a></td>
                                                                @elseif($data['status'] == 'Pending')
                                                                    <td style="vertical-align: middle;font-size: 13px;background-color: #ffefc5;color: #9c791c;padding-left: 25px;"
                                                                        id="{{ $data['assignment_id'] }}"><i
                                                                            class="far fa-clock"></i>
                                                                        {{ $data['status'] }} </td>
                                                                @elseif($data['status'] == 'Completed')
                                                                    <td style="vertical-align: middle;font-size: 13px;background-color: #e4ffe4;color: #4aa24a;padding-left: 25px;"
                                                                        id="{{ $data['assignment_id'] }}"><i
                ...
                @endif
                <!-- Assignment for instructor ends here -->
                <!-- Student assignment -->
                @if ($userType == 'student')
                    <div class="tab-pane fade" id="v-pills-personalizedActivity" role="tabpanel"
                        aria-labelledby="v-pills-personalizedActivity-tab">
                                            ...
                                            <div class="accordion" id="accordionExample">
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="headingThree">
                                                        <button class="accordion-button collapsed plus" type="button"
                                                            data-bs-toggle="collapse"
                                                            data-bs-target="#collapseThree_{{ $slno }}"
                                                            aria-expanded="false" aria-controls="collapseThree">
                                                            Session {{ $slno }} -
                                                            {{ $topicDetail['topic_title'] }}
                                                            @if ($topicDetail['isAssignmentSubmitted'] == true && $topicDetail['isAssignmentCompleted'] == true)
                                                                <span style=""
                                                                    class="badge pill text-dark status_btn">Completed</span>
                                                            @elseif($topicDetail['isAssignmentSubmitted'] == true)
                                                                <span style=""
                                                                    class="badge pill text-dark status_btn">Submitted</span>
                                                            @elseif(!$topicDetail['isAssignmentAssigned'] == true)
                                                                <span style="background-color:#ffebb9 !important;"
                                                                    class="badge pill text-dark status_btn">Not
                                                                    Assigned</span>
                                                            @else
                                                                <span style=""
                                                                    class="badge pill text-dark status_btn">Pending</span>
                                                            @endif
                                                        </button>
                                                    </h2>


                                                    <div id="collapseThree_{{ $slno }}"
                                                            ...
                                                            @foreach ($topicDetail['assignmentList'] as $assignment)
                                                                <div class="col-12 mb-3">
                                                                    <div class="card assignmentCard"
                                                                        id="card_{{ $topicDetail['topic_id'] }}">
                                                                        <div class="card-title p-3 bg-light border-bottom">
                                                                            <strong>
                                                                            Assignment:
                                                                            {{ $assignment['assignment_title'] }}</strong>
                                                                        </div>
                                                                        <div class="card-body">
                                                                            <p class="card-text">
                                                                            ...
                                                                            <div class="row">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-lg-10">
                                                                                            @if ($assignment['document'] != null)
                                                                                                <p style="color:#6E7687;"
                                                                                                    class="mt-4">
                                                                                                    External Link</p>
                                                                                                <a target="_blank"
                                                                                                    href="/storage/assignmentAttachments/{{ $assignment['document'] }}">{{ $assignment['document'] }}</a>
                                                                                ...
                                                                                <div
                                                                                    class="d-flex justify-content-center col-lg-12">
                                                                                    <div class="card mb-3"
                                                                                        style="border: 2px dashed rgba(0,0,0,.125);border-radius: 1rem;width: 100%;padding: 0rem 0rem 1.5rem 0rem;">
                                                                                        ...
                                                                                        @if ($topicDetail['isAssignmentSubmitted'] == true && $topicDetail['isAssignmentCompleted'] == true)
                                                                                            <div
                                                                                                ...
                                                                                                <p>This assignment was
                                                                                                    sbmitted and reviewed by
                                                                                                    the instructor.
                                                                                                    Greatjob!</p>
                                                                                            </div>
                                                                                        @elseif($topicDetail['isAssignmentSubmitted'] == true)
                                                                                        ...
                                                                                        @elseif(!$topicDetail['isAssignmentAssigned'] == true)
                                                                                            <div
                                                                                                class="col-12 m-auto text-center">
                                                                                                <p>No assignment has been
                                                                                                    assigned here.</p>
                                                                                            </div>
                                                                                        @else
                                                                                            <div class="card-body">
                                                                                                <div class="llpcard-inner bg-light mt-3 mb-3 p-3"
                                                                                                    id="cardbody_{{ $topicDetail['topic_id'] }}"
                                                                                                    style="display:none;">
                                                                                                    <h5
                                                                                                        class="card-title">
                                                                                                        Type your comment
                                                                                ...
                                                                                <div class="card card-body mb-3" style="background-color: transparent;background-clip: border-box;border: none;">
                                                                                    <div class="row p-2 flex-fill bd-highlight">
                                                                                        <div class="col-lg-3"> Attach File:
                                                                                        </div>
                                                                                        <div class="col-lg-6 col-12">
                                                                                            <label>Upload from device</label>
                                                                                            <input class="form-control assignmentStudentFile" type="file" name="assignment_upload" />
                                                                                            <small class="fst-italic">Supported Formats are: pdf, doc, docx</small>
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <button
                                                                                            card-id="{{ $topicDetail['topic_id'] }}"
                                                                                            class="btn think-btn-secondary start_assignment"
                                                                                            href="">Start
                                                                                            Assignment</button>
                                                                                    </div>
                                                                    @endif
                ...
                <div class="card-body">
                        ...
                        @if (!empty($achievedBadgeDetails))
                            @foreach ($achievedBadgeDetails as $achievedBadgeDetail)
                                <div class="col-lg-2 col-md-3 col-sm-3 col-3 text-center">
                                    <img src="{{ asset('/storage/achievementBadges/' . $achievedBadgeDetail['badge_image']) }}"
                                        alt="{{ $achievedBadgeDetail['badge_name'] }}" class="d-block mx-auto">
                    ...
                    <div class="row pt-5 pb-5 d-flex mb-3">
                        @foreach ($upcoming as $upcomingBadge)
                            <div class="col-lg-2 col-md-3 col-sm-3 col-3 text-center">
                                <img src="{{ asset('/storage/achievementBadges/' . $upcomingBadge['badge_image']) }}"
                                    alt="{{ $upcomingBadge['badge_name'] }}" class="d-block mx-auto">
                    ...
                    @foreach ($badgesDetails as $badgesData)
                        <div class="row d-flex my-5">
                            <div class="col-lg-2 col-md-3 col-sm-3 col-3 text-center">
                                <img src="{{ asset('/storage/achievementBadges/' . $badgesData['badge_image']) }}"
                                    alt="">
                        ...
                        <div class="card-body p-4">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-4 col-sm-6 col-12 mb-4  border-bottom">
                                    @if ($progress == 100)
                                        @foreach ($singleCourseDetails as $course)
                                            <a href="{{ route('generate-certificate', $course['id']) }}"
                                                class="btn p-2 mb-3 download_certificate">Download certificate</a>
                                        @endforeach
                                    @endif
                                </div>
                            </div>
                                    ...
                                    @if ($progress == 100)
                                        <div class="tab-content" id="pills-tabContent">
                                            ...
                                            <div class="tab-pane fade show active" id="pills-certificate" role="tabpanel"
                                                aria-labelledby="pills-back-certificate">
                                                <div class="col-lg-12 d-flex justify-content-center">
                                                    <div class="card text-center pill_card"
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <small
                                                                style="position: absolute; right: 45px; top:40px;"></small>
                                                            <img src="/storage/icons/ty_mac__transparent__1000.png" alt=""
                                                            ...
                                                            <div style="background:#FFFEF5;">
                                                                ...
                                                                <p class="card-text-2-certificate">
                                                                    @foreach ($singleCourseDetails as $course)
                                                                        ...
                                                                        {{ $course['student_lastname'] }}
                                                                    @endforeach
                                                                </p>
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <p class="card-text-1 completion_info">Has
                                                                            successfully completed the
                                                                            {{ $course['course_title'] }} <br>
                                                                            online cohort on {{ $course_completion }}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        @foreach ($singleCourseDetails as $course)
                                                                            <img src="{{ asset('/storage/signatures/' . $course['instructor_signature']) }}"
                                                                                alt="" class="img-fluid"
                                                                    ...
                                                                    <div class="col-lg-12 mt-4">
                                                                        ...
                                                                        <p class="card-text-1 team_text">&<br>Team ThinkLit
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        @else
                                            <div class="card text-center pill_card not_completed"
                                                style="margin: auto; width: 100%;">
                                                <div class="card-body">
                                                    <img src="{{ asset('/storage/images/Page-1.png') }}" alt=""
                                                        class="img-fluid">
                                                    <p class="card-text-2-certificate-1"><span class="welcome_text">Hi
                                                            @foreach ($singleCourseDetails as $course)
                                                                ...
                                                                {{ $course['student_lastname'] }}
                                                            @endforeach
                                                            , you haven't finished the course yet!
                                                        </span>
                                                        <span class="complete_warning">Complete the course to get
                                                            certificate</span>
                                                    </p>
                                                </div>
                                            </div>
...
@push('child-scripts')
    <script>
        ...
        instructModal.addEventListener('show.bs.modal', function(event) {
            ...
            let path = "{{ route('get-instructor-assignment-modal') }}?assignment_id=" + assignment +
                "&batch_id=" + batch_id;
            ...
            fetch(path, {
                ...
                document.getElementById('modal_file_download').href = "/storage/assignmentAnswers/" + data
                    .assignmentDoc;
            });
        });
        ...
        if (userTypes === 'student') {
            ...
            if (cancelAssignmentEl != null) {
                cancelAssignmentEl.addEventListener('click', function(e) {
                    ...
                    document.getElementById('cardbody_' + id).parentElement.nextElementSibling.firstElementChild
                        .style.display = 'block';
                });
            }
        ...
        document.getElementById('reviewSubmitBtn').addEventListener('click', (event) => {
            ...
            let path = "{{ route('student.course.review.post') }}?course_id=" + courseId + "&user_id=" +
                userId + "&comment=" + comment + "&rating=" + finalRating;
        ...
        document.getElementById('submitStudentQuestion').addEventListener('click', function(e) {
            ...
            let path = "{{ route('ask.question') }}?question=" + question + '&course_id=' + document
                .getElementById('course_id').value;
    ...
    @if ($userType == 'instructor')
        <script>
            ...
            document.getElementById('chartModal').addEventListener('show.bs.modal', function(event) {
                ...
                let path = "{{ route('get-individual-student-chart') }}?student=" + student + "&topic=" + topic +
                    "&course=" + course;
                fetch(path, {
                    method: 'POST',
                    headers: {
                    ...
                    google.charts.setOnLoadCallback(function() {
                        drawChart(jsondata.contentCount, jsondata.contents, jsondata.student)
                    });
                });
                setTimeout(hideAxisLabels, 500);

                function hideAxisLabels() {
                    let axisElements = document.getElementById('graph_div').getElementsByTagName('g')[4]
                    ...
                    let title = document.getElementById('graph_div').getElementsByTagName('g')[0].getElementsByTagName(
                        'text')[0];
        ...
        <script>
            ...
            for (i = 0; i < msgBtnLength; i++) {
                messageBtn[i].addEventListener('click', function(e) {
                    location.replace('/instructor-chat/?student=' + this.getAttribute('data-student') + '&instructor=' +
                        this.getAttribute('data-instructor') + '&course=' + this.getAttribute('data-course') +
                        '&batch=' + document.getElementById('batch_id').value);
                })
            }
            ...
            document.getElementById('name-search-btn').addEventListener('click', function(e) {
                ...
                let path = "{{ route('recommendation-search') }}?courseId=" + courseId + "&selectedBatch=" +
                    selectedBatch + "&searchTerm=" + searchTerm;
