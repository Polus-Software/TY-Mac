                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-12 d-flex justify-content-lg-end justify-content-md-end mt-2">
                                        ...
                                        @else
                                        <a style="background-color: #74648C;color: white;" type="button" target="_blank" class="btn" href="/session-view/{{ $topicDetail['liveId'] }}?batchId={{ $selectedBatch }}"><i class="fas fa-eye pe-2"></i>View live session</a>
                                        @endif
                                    </div>
                                </div>
