...
<div class="container" style="height:80vh;padding-top: 10%;">
    <div class="row bg-white mt-5 mb-5">
        <div class="col-lg-12 d-flex justify-content-center">
            <h1 class="pt-5" id="login-text">Please login!</h1>
        </div>

        <div class="col-lg-12 d-flex justify-content-center">
            <h5 class="" id="login-content">Click on the button below to login.</h5>
        </div>
...
<script>
    function loginLoad() {
        ...
        if(session_id != null) {
            ...
            document.getElementById('login-text').innerHTML = "Please login to view live session";
