<div class="col-lg-4 col-md-4 col-sm-4 col-4 mb-4">
    <div class="card-1">
        @if($page ==='assigned')
        <img src="/storage/courseThumbnailImages/{{ $course['image'] }}" class="card-img-top" alt="..." style="height: 220px;">
        @else
        <img src="/storage/courseThumbnailImages/{{ $course['course_thumbnail_image'] }}" class="card-img-top" alt="..." style="height: 220px;">
        @if($cardtype === 'live')
