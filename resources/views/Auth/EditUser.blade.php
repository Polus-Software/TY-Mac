    ...
    <div class="modal-content">
      ...
      <form enctype="multipart/form-data" method="POST" action="{{ route('change.avatar.post') }}">
        ...
        <div class="modal-footer">
          <button type="button" class="btn think-btn-secondary-outline" data-bs-dismiss="modal">Cancel</button>
          <button type="submit" class="btn think-btn-secondary" id="uploadButton">Upload</button>
        </div>
      </form>
    </div>
  </div>
              ...
              <div class="content-page">
                  <div class="content-top">
                      <div class="card col-sm-8 mx-auto">
                        <img class="card-img-top rounded-circle mx-auto" src="{{asset('/storage/images/'.Auth::user()->image)}}" alt="profilepicture" style="object-fit: cover;">
