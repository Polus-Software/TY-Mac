    ...
    <div class="col-8 right_card_block">
      ...
      <main>
        ...
        <div class="py-4"><h3 class="titles">Instructor details</h3></div>
          <div class="col-md-2">
          <img src="{{ asset('/storage/images/'.$instructorDetails['instructor_image']) }}" class="img-fluid rounded-circle float-start think-icon-md" alt="avatar">
       </div>
        <div class="col-md-3">
          ...
          <div class="row d-flex justify-content-start mt-3">
            ...
            <div class="col-md-12">
              <div class="row">
                ...
                <div class="col-lg-8">
                <img src="{{ asset('/storage/signatures/'.$instructorDetails['instructor_signature']) }}" class="img-fluid float-start think-icon-mdlg" alt="">
                </div>
              </div>
            </div>
          </div>         
