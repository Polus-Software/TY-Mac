          ...
          <table class="table llp-table students_table">
            ...
            <tbody>
              ...
              <tr id="{{$studentData['id'] }}">
                ...
                <img src="{{ asset('/storage/images/'.$studentData['image']) }}"  class="rounded-circle think-icon-sm" alt="avatar">
                </td>
              ...
              @else
                 <tr>
                     <td colspan="8"><h6 class="text-center">No students registered.</h6></td>
                 </tr>
                 @endif
            </tbody>
          </table>
