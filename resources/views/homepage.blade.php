...
<!-- home banner-->
<!-- <header class="d-flex align-items-center llp-home-banner">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 col-sm-12 d-flex align-items-center p-3">
        ...
        <div class="col-lg-6 col-12">
          <img src="courselist/Illustration/bannerhome.png" class="img-fluid" alt="courseimage">
        </div>
      </div>
    </div>
</header> -->
