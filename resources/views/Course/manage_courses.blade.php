          ...
          <table class="table llp-table">
            ...
            {{$courseDatas}}
              ...
              <tr id="{{$courseData['id']}}">
                ...
                <td class="align-middle">{{$courseData['category']}}</td>
                ...
                <td class="align-middle"><span id="publish-badge" class="badge bg-warning text-dark">Draft</span></td>
                @else
                <td class="align-middle"><span id="publish-badge" class="badge bg-success text-dark">Published</span></td>
                @endif
              ...
              @else
                 <tr>
                     <td colspan="8"><h6 class="text-center">No courses added.</h6></td>
                 </tr>
              @endif
            </tbody>
          </table></div>
...
<div id="delete_course_modal" class="modal fade llp-modal" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header pb-0 pe-5 ps-5 pt-3">
