    ...
    <div class="modal-dialog">
      <div class="modal-content border-0">
        ...
        <!-- include timezones here -->
              ...
              <div class="form-group mx-0">
              <label for="inputPassword" class="password-label">Password
                <i class="far fa-question-circle text-muted ms-1 float-none" data-bs-toggle="tooltip" data-bs-placement="top" title="Passwords must be at least 5 characters long and utmost 15 characters long with atleast one digit and one special character and letters."></i>
              </label>
      ...
      <div class="modal-content border-0">
        ...
        <div class="modal-body">
          <div class="container-overlay">
              ...
              <div class="form-group mx-0">
                <textarea class="form-control autosize" id="comment" placeholder="Add your review..." rows="4" maxlength="1000"></textarea>
              </div>
              <div class="form-group mx-0">
              @csrf
        ...
        <div class="modal-body">
          <div class="container-overlay">
            <form id="contactFormCourse" class="form" method="POST" action="{{route('question')}}">
              ...
              <div class="form-group mx-0">
                <label for="message" class="message-label">Type your question here</label>
              ...
              <div class="form-group mx-0">
                <button type="submit" class="btn think-btn-secondary sendContactInfo w-100">Send</button>
              </div>
...
document.querySelector('#signupForm').addEventListener('submit', (e) => {
      ...
      if(!password.value.match(/^.*(?=.{3,})(?=.*[a-zA-Z])(?=.*[0-9])(?=.*[\d\x])(?=.*[!-_:$#%]).*$/)) {
        e.preventDefault();
        showError(password, 'Password must contain one special character, number and alphabets.');
      }
    });
