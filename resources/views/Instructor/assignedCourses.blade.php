                        ...
                        <div class="col-lg-12">
                            <div id="liveCarousel" class="carousel slide" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    ...
                                    <div class="row">
                                    @endif
                                    <x-courseboxlive :course="$liveSessionDetail" cardtype="live" page="assigned"></x-courseboxlive>
                        ...
                        <div class="col-lg-12">
                            <div id="upcomingCarousel" class="carousel slide" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    ...
                                    <div class="row">
                                    @endif
                                            <x-courseboxlive :course="$upComingSessionDetail" cardtype="upcoming" page="assigned"></x-courseboxlive>
                                            @if(($loop->iteration % 3 == 0) && (!$loop->last))
                                            </div>
                                            </div>
                                            <div class="carousel-item">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg col-md-3 col-sm-4 col-12 d-flex justify-content-end">
                                                <p class="para-2 text-truncate think-text-color-grey fw-bold"><i class="far fa-user pe-1"></i>
