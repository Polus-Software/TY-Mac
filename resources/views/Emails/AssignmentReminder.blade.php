...
The deadline for completing the assignment for the course {{$data['course_name']}} is {{$data['date']}}. That's one day from now. Please make sure you've finished the assignment by then.
